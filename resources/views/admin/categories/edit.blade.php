...
@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="bg-white border border-slate-200 rounded-2xl shadow-sm p-6">
            ...
            <form method="POST" action="{{ route('admin.categories.update', $category) }}" class="mt-5 space-y-5">
                @csrf
                @method('PUT')
...
@section('scripts')
    @include('admin.partials.dynamic-fields-script', ['initialFields' => old('dynamic_fields', $category->dynamic_fields ?? [])])
@endsection
