...
@section('title', __('admin.manage_cities'))

@section('content')
    <div class="space-y-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            <h1 class="text-2xl font-semibold text-slate-900">{{ __('admin.cities') }}</h1>
            <a
                        ...
                        <tr class="hover:bg-slate-50/80 transition">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <form method="POST" action="{{ route('admin.cities.destroy', $city) }}" onsubmit="return confirm('{{ __('admin.confirm_delete') }}')">
                                        @csrf
                                        @method('DELETE')
