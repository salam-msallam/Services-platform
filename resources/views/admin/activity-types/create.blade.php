...
@section('title', __('admin.create_activity_type'))

@section('content')
    <div class="max-w-xl mx-auto">
        <div class="bg-white border border-slate-200 rounded-2xl shadow-sm p-6">
            <h1 class="text-xl font-semibold text-slate-900">{{ __('admin.create_activity_type') }}</h1>
            ...
            <form method="POST" action="{{ route('admin.activity-types.store') }}" class="mt-5 space-y-4">
                @csrf
